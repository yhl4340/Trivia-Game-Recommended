// globals----------------------------------------------------------trying for the ad verion
var correct = 0;
var incorrect = 0;
var score = 0;
var timeRunning = 30;
...
var questions = [
  ...
  },
  {
    ...
    imageWrong: "assets/images/no1.gif"
  },
  // {title:
...
//arrays of images to take from for both wrong and right guesses
...
function check(userGuess) {
    ...
    //if the correct ans, show an image associated with that question
    if (userGuess == question.correct) {
      correct++;
      $("#summary-text")
      .html("That is right!")
      .css("text-align", "center");
      $('#img').attr('src', question.imageRight).show();
      ...
      .css("text-align", "center");
      incorrect++;
      $('#img').attr('src', question.imageWrong).show();
      console.log($('#img').attr('src', question.imageWrong).show());
